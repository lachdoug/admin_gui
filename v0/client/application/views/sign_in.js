						...
						form( {
							...
							components: function(f) {
								return [
									...
									f._field( { label: false, name: "data[interface]", type: "select", required: true, title: "Select administration interface", collection: { system_admin:"System admin", user_admin: "User admin"} } ),

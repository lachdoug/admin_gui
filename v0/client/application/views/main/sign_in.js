				...
				{ style: "display: inline-block; text-align: left; width: 80%; max-width: 300px; margin-top: 50px;",
					$components: [
						...
						form( {
							components: [
								{ $type: "hr" },
								formField( { name: "data[mybox2]", label: "This is :checkbox_boolean", type: "checkbox_boolean" } ),
								...
								enginesField( { name: "data[something3]", value: "c", mandatory: true, input: { collection: { include_blank: true, items: [ ["a", "A"],["b", "B"],["c", "C"],["d", "D"] ] } , type: "checkboxes", label: "This is :checkboxes", placeholder: "This is a placeholder" } } ),
